...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => TeacherProfilePage( teacherId: '647c8dfd0e99666edb897d6e')
                ),
              );
            },
                        child: CircleAvatar(
      ...
      Container(
                    decoration: BoxDecoration(
                      color: Colors.blue.shade50, // Changed to white background
                      borderRadius: BorderRadius.all(Radius.circular(20)),
                    ),
                    width: double.infinity,
                    height: 120,
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              primary: Colors.blue, // Changed Join button color to blue
                            ),
                          ),
                        ],
                      ),
